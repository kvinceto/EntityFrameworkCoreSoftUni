        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nationality = table.Column<string>(type: "nvarchar(40)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RegistrationNumber = table.Column<string>(type: "char(8)", nullable: true),
                    VinNumber = table.Column<string>(type: "char(17)", nullable: false),
                    TankCapacity = table.Column<int>(type: "int", nullable: false),
                    CargoCapacity = table.Column<int>(type: "int", nullable: false),
                    CategoryType = table.Column<string>(type: "varchar(12)", nullable: false),
                    MakeType = table.Column<string>(type: "varchar(8)", nullable: false),
